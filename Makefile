...
OUTPUT_FILES_O = $(LEX_OUT_FILE).o $(YACC_OUT_FILE).o
...
$(OUTPUT): $(LEX_OUT_FILE).o $(YACC_OUT_FILE).o
	$(CC) $(CC_FLAGS) -o $(OUTPUT) $(LEX_OUT_FILE).o $(YACC_OUT_FILE).o 
...
$(LEX_OUT_FILE).c: $(YACC_OUT_FILE).c
