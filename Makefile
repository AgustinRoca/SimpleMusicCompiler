...
OUTPUT_FILES_O = $(OUTPUT_FILES_C:.c=.o) $(SORTED_HASHMAP_FILE).o
...
debug:
	...
	$(CC) -o $(OUTPUT) $(LEX_OUT_FILE).c $(YACC_OUT_FILE).c $(SORTED_HASHMAP_FILE).c $(CC_FLAGS)

macos: $(FILE_Y) $(FILE_L) $(SORTED_HASHMAP_FILE).c
	$(YACC) $(YACC_FLAGS) $(FILE_Y)
	$(LEX) $(LEX_FLAGS) $(FILE_L)
	$(CC) -o $(OUTPUT) $(CC_FLAGS_MACOS) $(LEX_OUT_FILE).c $(YACC_OUT_FILE).c $(SORTED_HASHMAP_FILE).c
macos_debug:
	$(YACC) $(YACC_FLAGS) $(YACC_DEBUG) $(FILE_Y)
	$(LEX) $(LEX_FLAGS) $(LEX_DEBUG) $(FILE_L)
	$(CC) -g -o $(OUTPUT) $(CC_FLAGS_MACOS) $(LEX_OUT_FILE).c $(YACC_OUT_FILE).c $(SORTED_HASHMAP_FILE).c
